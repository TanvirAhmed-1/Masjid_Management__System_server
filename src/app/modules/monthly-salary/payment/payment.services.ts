...
const createPayment = async (payload: TCreatePayment & { userId: string }) => {
...
const getYearlyCollection = async ({
  year,
  mosqueId,
  page,
  limit,
...
const deletePaymentBD = async (paymentId: string, mosqueId?: string) => {
  if (!paymentId) {
